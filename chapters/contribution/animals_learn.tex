...
\begin{figure}
    ...
    \label{fig:iti}
\end{figure} %Intertrial interval also
% fazer eixo X: % de trials da sessão
% Reta horizontal 5 minutos

\begin{figure}
    \centering
    % \begin{tabular}{cccc}
    %  \includegraphics[width=3.5cm]{elementos-textuais/behav_7.eps}
    %  &  \includegraphics[width=3.5cm]{elementos-textuais/behav_8.eps}
    %  & \includegraphics[width=3.5cm]{elementos-textuais/behav_9.eps}
    %  & \includegraphics[width=3.5cm]{elementos-textuais/behav_10.eps}
    % \end{tabular}
