\chapter{Representation change through learning}
...
\begin{figure}
    ...
    \includegraphics[width=8cm]{elementos-textuais/PFC_init_vs_end.eps}
    & 
    \includegraphics[width=8cm]{elementos-textuais/STR_PFC_day1_vs_day2_evo.eps}
    \end{tabular}
