...
% Nossas hipóteses são... por isso temos ...
...
\section{They get tired in long sessions}
    ...
    % Our rational is that it is important that animals are engaged in the task
...
\section{Response patterns show signs of learning in few hundred trials}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{figures/behavior_group_1.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{figures/behavior_group_2.png}
